...
set_property -dict { PACKAGE_PIN C9  IOSTANDARD LVCMOS33 } [get_ports {max_frequency[9]}]
set_property -dict { PACKAGE_PIN A9  IOSTANDARD LVCMOS33 } [get_ports {max_frequency[8]}]
set_property -dict { PACKAGE_PIN B3  IOSTANDARD LVCMOS33 } [get_ports {max_frequency[7]}]
set_property -dict { PACKAGE_PIN D9  IOSTANDARD LVCMOS33 } [get_ports {max_frequency[6]}]
set_property -dict { PACKAGE_PIN C10 IOSTANDARD LVCMOS33 } [get_ports {max_frequency[5]}]
set_property -dict { PACKAGE_PIN C11 IOSTANDARD LVCMOS33 } [get_ports {max_frequency[4]}]
set_property -dict { PACKAGE_PIN D10 IOSTANDARD LVCMOS33 } [get_ports {max_frequency[3]}]
set_property -dict { PACKAGE_PIN B9  IOSTANDARD LVCMOS33 } [get_ports {max_frequency[2]}]
set_property -dict { PACKAGE_PIN A10 IOSTANDARD LVCMOS33 } [get_ports {max_frequency[1]}]
set_property -dict { PACKAGE_PIN D5  IOSTANDARD LVCMOS33 } [get_ports {max_frequency[0]}]
